...
public final class IBatisDaoUtils {
    ...
    public static String getPrimaryKeyFieldName(Object o) {
        ...
        // log.debug(o.getClass().getSimpleName().toString() + "Id");

        // return o.getClass().getSimpleName().toString() + "Id";
    ...
    protected static String getPrimaryKeyFieldNameFromClass(Class cls) {
    ...
    /**
     * Prepare object for save or update by looking for a "version" field and
     * incrementing it if it exists. This should probably be changed to look for
     * the @Version annotation instead.
     * 
     * @param o
     *            the object to examine
     */
    ...
    protected static void setPrimaryKey(Object o, Class clazz, Object value) {
        ...
        // firstly, set super class
        // Class superC = o.getClass().getSuperclass();
        // while (!superC.getName().equals(BaseObject.class.getName())) {
        // log.debug(superC.getName());
        // try{
        // Method setMethod = superC.getMethod(setMethodName, clazz);
        // if (value != null) {
        ...
        // if there is no method in super class, set it in current class
        try {
            ...
            e.printStackTrace();
            log.error(MessageFormat.format("Could not set ''{0}.{1} with value {2}", ClassUtils.getShortName(o.getClass()), fieldName, value));
        }
    }
