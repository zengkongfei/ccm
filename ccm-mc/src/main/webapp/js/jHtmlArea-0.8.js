    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        increaseFontSize: function () {
            if ($browser.msie === true) {
            	...
            	//this.ec("fontSize", false, this.qc("fontSize") + 1);
            	var span = $(this.iframe[0].contentWindow.document.createElement("span"));
            	var rang = this.getRange();
            	rang.surroundContents(span.css("font-size", "larger")[0]);
            	var sel = this.getSelection()
                sel.removeAllRanges();
                sel.addRange(rang);
            } else {
        ...
        decreaseFontSize: function () {
            if ($browser.msie === true) {
            	...
            	var span = $(this.iframe[0].contentWindow.document.createElement("span"));
            	var rang = this.getRange();
            	rang.surroundContents(span.css("font-size", "smaller")[0]);
            	var sel = this.getSelection()
                sel.removeAllRanges();
                sel.addRange(rang);
            } else {
