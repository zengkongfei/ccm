...
<div class="pp_main">
    ...
    <pre><s:property value="#request.sendMsgLog.message"/><s:property value="#request.receiveMsgLog.message"/></pre>
	</div>
...
function doExport() {
    ...
    document.searchForm.action = '/upDownLog_export.do?udpcId=${udpcId}&upDown=${upDown}&hotelCode=${requestScope.receiveMsgLog.hotelCode}${requestScope.sendMsgLog.hotelCode}';
