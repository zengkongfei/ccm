...
<div class="title_wp">
	<div class="bt">
		<a href="/${prefix}_edit.do?from=4" class="btn_2 blue"><fmt:message key="common.button.New"/></a>
	</div>
	<s:if test="from==2">
	<fmt:message key="ccm.HotelUser"/>
	</s:if>
	<s:elseif test="#attr.SPRING_SECURITY_CONTEXT.authentication.principal.companyId.equals(\"2\")">
	用户管理
	</s:elseif>
	<s:else>
