...
<div class="CCMmainConter w1200 " style="width: 960px;">
	<div class="title_channelbooking"><fmt:message key='ccm.WBEUI.ConfirmationLetter'/></div>
	<table class="table" border="1"  bordercolor="#9263B7">
		<tbody>
			<tr class="tr_channelbook">
				<td class="tr_channelbook_td_title tr_channelbook_td" style="border-top:0px;"><span class="STYLE5"><fmt:message key='ccm.UserActivityLog.PropertyName'/></span> </td>
				<td style="border-top:0px;" class="tr_channelbook_td"><span class="STYLE5">${wbeOrderVO.hotelName }</span></td>
				...
				<td style="border-top:0px;" class="tr_channelbook_td"><span class="STYLE5">${wbeOrderVO.staDesp}</span></td>
			</tr>
			<tr class="tr_channelbook">
			...
			<tr class="tr_channelbook">
				...
				<td style="border-top:0px;" class="tr_channelbook_td"><span class="STYLE5">${wbeOrderVO.roomTypeName }</span></td>
			...
			<tr class="tr_channelbook">
				<td class=" tr_channelbook_td" style="border-top:0px;" colspan="3"><span class="STYLE5"><fmt:message key="ccm.WBEUI.RatesPernight"/>： ${wbeOrderVO.oneRoomCharge }${wbeOrderVO.currencyCode }</span></td>
			</tr>
		</tbody>
	</table>
	<c:forEach items="${wbeOrderVO.wbeGuestVoList }" var="wbeGuestVo" varStatus="i">
		<table class="table" border="1"  bordercolor="#9263B7">
			<tbody>
				<tr class="tr_channelbook">
					<td class="tr_channelbook_td_title tr_channelbook_td" style="border-top:0px;" colspan="4">
					<span class="STYLE5"><fmt:message key="ccm.WBEUI.GuestInformation"/>${i.index+1 }</span> 
					</td>
	...
	<div align="center">
		<a href="javascript:submit();" class="btn_1 blue" id="submit"><fmt:message key="ccm.WBEUI.DownloadConfriamtion"/></a>
	</div>
...
$(document).ready(function() {
	...
	function submit(){
		document.nextForm.action = "/channelBookIng_exportBookingPDF.do"
