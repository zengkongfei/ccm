...
@XmlSeeAlso({
    org.opentravel.ota._2003._05.OTAVehModifyRQ.VehModifyRQInfo.class
})
public class VehicleModifyRQAdditionalInfoType {
    ...
    public static class CoveragePrefs {
        ...
        protected List<VehicleModifyRQAdditionalInfoType.CoveragePrefs.CoveragePref> coveragePref;
        ...
        public List<VehicleModifyRQAdditionalInfoType.CoveragePrefs.CoveragePref> getCoveragePref() {
            if (coveragePref == null) {
                coveragePref = new ArrayList<VehicleModifyRQAdditionalInfoType.CoveragePrefs.CoveragePref>();
            }
