...
public class OTAInsuranceQuoteRQ {

    @XmlElement(name = "POS")
    protected POSType pos;
    @XmlElement(name = "PlanForQuoteRQ", required = true)
    protected List<OTAInsuranceQuoteRQ.PlanForQuoteRQ> planForQuoteRQ;
     ...
     * {@link OTAInsuranceQuoteRQ.PlanForQuoteRQ }
     * 
     * 
     */
    public List<OTAInsuranceQuoteRQ.PlanForQuoteRQ> getPlanForQuoteRQ() {
        if (planForQuoteRQ == null) {
            planForQuoteRQ = new ArrayList<OTAInsuranceQuoteRQ.PlanForQuoteRQ>();
        }
