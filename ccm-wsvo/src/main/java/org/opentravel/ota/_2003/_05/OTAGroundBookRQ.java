 ...
 *         &lt;element name="GroundReservation" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                   &lt;choice>
 *                     &lt;element name="Service" type="{http://www.opentravel.org/OTA/2003/05}GroundServiceDetailType" minOccurs="0"/>
 *                     &lt;element name="Shuttle" type="{http://www.opentravel.org/OTA/2003/05}GroundShuttleResType" minOccurs="0"/>
 *                   &lt;/choice>
...
@XmlRootElement(name = "OTA_GroundBookRQ")
public class OTAGroundBookRQ {

    @XmlElement(name = "POS", required = true)
    protected POSType pos;
    @XmlElement(name = "Reference")
    protected List<UniqueIDType> reference;
    @XmlElement(name = "GroundReservation", required = true)
    protected List<OTAGroundBookRQ.GroundReservation> groundReservation;
    @XmlElement(name = "Payments")
    protected OTAGroundBookRQ.Payments payments;
    ...
    /**
     * Gets the value of the groundReservation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the groundReservation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGroundReservation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OTAGroundBookRQ.GroundReservation }
     * 
     * 
     */
    public List<OTAGroundBookRQ.GroundReservation> getGroundReservation() {
        if (groundReservation == null) {
            groundReservation = new ArrayList<OTAGroundBookRQ.GroundReservation>();
        }
     ...
     * @return
     *     possible object is
     *     {@link OTAGroundBookRQ.Payments }
     *     
     */
    public OTAGroundBookRQ.Payments getPayments() {
        return payments;
    }
     ...
     *     
     */
    public void setPayments(OTAGroundBookRQ.Payments value) {
        this.payments = value;
    }
    ...
    public static class GroundReservation {
        ...
        protected GroundServiceDetailType service;
        @XmlElement(name = "Shuttle")
        protected GroundShuttleResType shuttle;
        @XmlElement(name = "RateQualifier")
        protected List<OTAGroundBookRQ.GroundReservation.RateQualifier> rateQualifier;
        @XmlElement(name = "Payments")
        protected OTAGroundBookRQ.GroundReservation.Payments payments;
        @XmlElement(name = "Reference")
         ...
         *     
         */
        public GroundServiceDetailType getService() {
            return service;
        }
         ...
         *     
         */
        public void setService(GroundServiceDetailType value) {
            this.service = value;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link OTAGroundBookRQ.GroundReservation.RateQualifier }
         * 
         * 
         */
        public List<OTAGroundBookRQ.GroundReservation.RateQualifier> getRateQualifier() {
            if (rateQualifier == null) {
                rateQualifier = new ArrayList<OTAGroundBookRQ.GroundReservation.RateQualifier>();
            }
         ...
         * @return
         *     possible object is
         *     {@link OTAGroundBookRQ.GroundReservation.Payments }
         *     
         */
        public OTAGroundBookRQ.GroundReservation.Payments getPayments() {
            return payments;
        }
         ...
         *     
         */
        public void setPayments(OTAGroundBookRQ.GroundReservation.Payments value) {
            this.payments = value;
        }
