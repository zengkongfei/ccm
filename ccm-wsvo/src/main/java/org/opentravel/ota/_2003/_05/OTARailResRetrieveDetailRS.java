 ...
 *           &lt;element name="RailReservation" type="{http://www.opentravel.org/OTA/2003/05}RailReservationType" maxOccurs="unbounded"/>
 *         &lt;/sequence>
...
@XmlRootElement(name = "OTA_RailResRetrieveDetailRS")
public class OTARailResRetrieveDetailRS {
    ...
    protected List<RailReservationType> railReservation;
     ...
     * 
     */
    public List<RailReservationType> getRailReservation() {
        if (railReservation == null) {
            railReservation = new ArrayList<RailReservationType>();
        }
