 ...
 *           &lt;element name="Reservation" type="{http://www.opentravel.org/OTA/2003/05}GroundReservationType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "OTA_GroundBookRS")
public class OTAGroundBookRS {
    ...
    protected List<GroundReservationType> reservation;
    @XmlElement(name = "Payment")
    protected OTAGroundBookRS.Payment payment;
     ...
     * 
     */
    public List<GroundReservationType> getReservation() {
        if (reservation == null) {
            reservation = new ArrayList<GroundReservationType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link OTAGroundBookRS.Payment }
     *     
     */
    public OTAGroundBookRS.Payment getPayment() {
        return payment;
    }
     ...
     *     
     */
    public void setPayment(OTAGroundBookRS.Payment value) {
        this.payment = value;
    }
