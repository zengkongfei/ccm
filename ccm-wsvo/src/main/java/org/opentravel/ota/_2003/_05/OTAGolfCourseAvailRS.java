 ...
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element name="GolfFacility" maxOccurs="unbounded" minOccurs="0">
 *             &lt;complexType>
 *               &lt;complexContent>
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence>
 *                     &lt;element name="FacilityInfo" type="{http://www.opentravel.org/OTA/2003/05}GolfFacilityType"/>
 *                     &lt;element name="TeeTime" type="{http://www.opentravel.org/OTA/2003/05}TeeTimeType" maxOccurs="99"/>
...
public class OTAGolfCourseAvailRS {
    ...
    protected OTAGolfCourseAvailRS.ProcessingInfo processingInfo;
    @XmlElement(name = "GolfFacility")
    protected List<OTAGolfCourseAvailRS.GolfFacility> golfFacility;
     ...
     * @return
     *     possible object is
     *     {@link OTAGolfCourseAvailRS.ProcessingInfo }
     *     
     */
    public OTAGolfCourseAvailRS.ProcessingInfo getProcessingInfo() {
     ...
     *     
     */
    public void setProcessingInfo(OTAGolfCourseAvailRS.ProcessingInfo value) {
     ...
     * {@link OTAGolfCourseAvailRS.GolfFacility }
     * 
     * 
     */
    public List<OTAGolfCourseAvailRS.GolfFacility> getGolfFacility() {
        if (golfFacility == null) {
            golfFacility = new ArrayList<OTAGolfCourseAvailRS.GolfFacility>();
        }
    ...
    public static class GolfFacility {
        ...
        protected GolfFacilityType facilityInfo;
        @XmlElement(name = "TeeTime", required = true)
        protected List<TeeTimeType> teeTime;
        @XmlElement(name = "TPA_Extensions")
        protected TPAExtensionsType tpaExtensions;
         ...
         * @return
         *     possible object is
         *     {@link GolfFacilityType }
         *     
         */
        public GolfFacilityType getFacilityInfo() {
            return facilityInfo;
        }
         ...
         *     
         */
        public void setFacilityInfo(GolfFacilityType value) {
         ...
         * 
         */
        public List<TeeTimeType> getTeeTime() {
            if (teeTime == null) {
                teeTime = new ArrayList<TeeTimeType>();
            }
            return this.teeTime;
        }
