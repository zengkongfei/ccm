...
@XmlRootElement(name = "OTA_GolfFacilityInfoRS")
public class OTAGolfFacilityInfoRS {
    ...
    protected List<OTAGolfFacilityInfoRS.GolfCourse> golfCourse;
     ...
     * {@link OTAGolfFacilityInfoRS.GolfCourse }
     * 
     * 
     */
    public List<OTAGolfFacilityInfoRS.GolfCourse> getGolfCourse() {
        if (golfCourse == null) {
            golfCourse = new ArrayList<OTAGolfFacilityInfoRS.GolfCourse>();
        }
