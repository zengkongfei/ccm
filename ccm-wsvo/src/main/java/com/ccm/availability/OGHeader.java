...
@XmlType(name = "OGHeader", namespace = "http://webservices.micros.com/og/4.3/Core/", propOrder = { "origin", "destination", "intermediaries", "authentication" })
public class OGHeader {
	...
	public static class Authentication {
		...
		@XmlElement(name = "UserCredentials", namespace = "http://webservices.micros.com/og/4.3/Core/", required = true)
		protected OGHeader.Authentication.UserCredentials userCredentials;
		@XmlElement(name = "Licence", namespace = "http://webservices.micros.com/og/4.3/Core/")
		...
		public static class Licence {
			...
			@XmlElement(name = "Key", namespace = "http://webservices.micros.com/og/4.3/Core/")
		...
		public static class UserCredentials {
			...
			@XmlElement(name = "UserName", namespace = "http://webservices.micros.com/og/4.3/Core/", required = true)
			protected String userName;
			@XmlElement(name = "UserPassword", namespace = "http://webservices.micros.com/og/4.3/Core/", required = true)
			protected String userPassword;
			@XmlElement(name = "Domain", namespace = "http://webservices.micros.com/og/4.3/Core/", required = true)
			protected String domain;
			@XmlElement(name = "SecurityId", namespace = "http://webservices.micros.com/og/4.3/Core/")
