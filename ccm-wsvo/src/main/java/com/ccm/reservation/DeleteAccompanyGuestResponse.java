...
@XmlRootElement(name = "DeleteAccompanyGuestResponse", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
public class DeleteAccompanyGuestResponse {
