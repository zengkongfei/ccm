...
@XmlRootElement(name = "EmailConfirmationRequest", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
public class EmailConfirmationRequest {
    ...
    @XmlElement(name = "EmailAddress", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl", required = true)
