 ...
 *         &lt;element name="UpgradeRoom" type="{http://webservices.micros.com/og/4.3/Reservation/}UpgradeRoom"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpgradeReservationRequest", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
public class UpgradeReservationRequest {
    ...
    @XmlElement(name = "MembershipID", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
    protected UniqueID membershipID;
    @XmlElement(name = "UpgradeRoom", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl", required = true)
    protected UpgradeRoom upgradeRoom;
     ...
     *     
     */
    public void setUpgradeRoom(UpgradeRoom value) {
        this.upgradeRoom = value;
    }
