 ...
 *         &lt;element name="UpsellOfferId" type="{http://webservices.micros.com/og/4.3/Common/}UniqueID"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpsellReservationRequest", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
public class UpsellReservationRequest {
    ...
    @XmlElement(name = "UpsellOfferId", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl", required = true)
    protected UniqueID upsellOfferId;
     ...
     *     
     */
    public UniqueID getUpsellOfferId() {
     ...
     *     
     */
    public void setUpsellOfferId(UniqueID value) {
