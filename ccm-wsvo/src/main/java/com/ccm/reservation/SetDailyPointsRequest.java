 ...
 *         &lt;element name="DailyPoints" type="{http://webservices.micros.com/og/4.3/HotelCommon/}TimeSpanPointsList"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetDailyPointsRequest", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl")
public class SetDailyPointsRequest {
    ...
    @XmlElement(name = "DailyPoints", namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl", required = true)
    protected TimeSpanPointsList dailyPoints;
     ...
     *     
     */
    public TimeSpanPointsList getDailyPoints() {
        return dailyPoints;
    }
     ...
     *     
     */
    public void setDailyPoints(TimeSpanPointsList value) {
